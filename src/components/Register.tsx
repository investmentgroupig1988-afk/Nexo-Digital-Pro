...
import { UserPlus, ArrowRight, Mail, User as UserIcon, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0B0E14] flex items-center justify-center p-4 selection:bg-amber-500/30">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white mb-2 tracking-tight">Crear Cuenta</h2>
          <p className="text-slate-400 text-sm">
            Regístrate para solicitar acceso a las señales.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="text-center mt-4 pt-4 border-t border-slate-800">
            <button type="button" onClick={onSwitchToLogin} className="text-xs text-slate-400 hover:text-amber-500 transition-colors">
